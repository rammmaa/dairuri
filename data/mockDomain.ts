...
export const mockBusStops: BusStop[] = [
  ...
  // H1 loop near Cheongdo-eup (interpolated around the terminal).
  ...
  // H2/H3 shared (Cheongdo-eup -> Hwayang Beomgok, interpolated to the Beomgok anchor).
  ...
  // H3 extras (Cheongdo-eup -> Hwayang Sinbong-ri, interpolated to the Sinbong anchor).
  ...
  // H4 extras (Cheongdo-eup -> Geumcheon Donggok, interpolated to the Donggok anchor).
  ...
  // H5 extras (Donggok -> Unmun Samgye, interpolated to the Daecheon / Unmunsa anchors).
  ...
  // H6 extras (Cheongdo-eup -> Songeup, interpolated north of the terminal).
...
export const mockBusRouteStops: MockBusRouteStop[] = [
  ...
  // H2: Cheongdo-eup -> Hwayang Beomgok.
  ...
  // H3: Cheongdo-eup -> Hwayang Sinbong-ri. Per the route doc, Chukhyeop and
  // Beomgok Humansia apt are excluded from the implemented route.
  ...
  { routeId: "route-happy-3", stopId: "stop-seongjo-apt", sequence: 3 },
  { routeId: "route-happy-3", stopId: "stop-bumin-apt", sequence: 4 },
  { routeId: "route-happy-3", stopId: "stop-county-office", sequence: 5 },
  { routeId: "route-happy-3", stopId: "stop-koaru-apt", sequence: 6 },
  { routeId: "route-happy-3", stopId: "stop-beomgok-crossroad", sequence: 7 },
  { routeId: "route-happy-3", stopId: "stop-sports-field", sequence: 8 },
  { routeId: "route-happy-3", stopId: "stop-dongcheon-ri", sequence: 9 },
  { routeId: "route-happy-3", stopId: "stop-eupseong", sequence: 10 },
  { routeId: "route-happy-3", stopId: "stop-hwayang-police", sequence: 11 },
  { routeId: "route-happy-3", stopId: "stop-seosang-super", sequence: 12 },
  { routeId: "route-happy-3", stopId: "stop-cheongseokgol-farm", sequence: 13 },
  { routeId: "route-happy-3", stopId: "stop-sinbong-hongdo", sequence: 14 },
  // H4: Cheongdo-eup -> Geumcheon Donggok.
