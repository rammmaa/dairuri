...
export const busSchedule: Record<string, BusScheduleEntry> = {
  ...
  "route-happy-3": {
    ...
    durationNote: "운행시간 20분 소요",
    rows: [
      { label: "기점", stop: "청도공용버스터미널", times: ["06:50", "10:30", "15:30"] },
      { label: "종점", stop: "신봉리(홍도)", times: ["07:20", "11:00", "16:00"] },
      { label: "기점", stop: "신봉리(홍도)", times: ["07:20", "11:00", "16:00"] },
      { label: "종점", stop: "청도공용버스터미널", times: ["07:50", "11:30", "16:30"] },
    ],
  },
  "route-happy-4": {
