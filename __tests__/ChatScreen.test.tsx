...
describe("ChatScreen", () => {
  it("renders the chat list first and opens the ride chat room", () => {
    ...
    expect(screen.queryByText("다산 1동 → 범어 1동\n월,수 7:00~8:00")).toBeNull();
  ...
  it("switches chat list between all, ride, and work tabs and toggles unread filter", () => {
    ...
    expect(screen.queryByText("농촌 일손과 카페 보조 도울 수 있어요")).toBeNull();
    ...
    expect(screen.queryByText("‘청도감 학원’ 함께 다니실 사람 구해요")).toBeNull();
  });
